      ...
      <div className="contact-card">
        <div className="contact-visual">
          ...
          <div className="contact-visual-inner">
            <span className="eyebrow" style={{ background: "rgba(255,255,255,0.14)", color: "var(--cream)" }}>✦ We read every message</span>
            <h2>Let&apos;s start a conversation.</h2>
            <p>
              Questions about an order, a subscription, or just want a recommendation for a tricky reader?
              We&apos;re a small team and we answer everything ourselves: no ticket numbers, no bots.
            </p>
