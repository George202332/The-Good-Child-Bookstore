        ...
        <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 13 }}>
          <thead>
            <tr style={{ textAlign: "left" }}>
              {["Date", "Book", "Sale amount", "Your commission"].map((h) => (
          ...
          <tbody>
            {rows.length === 0 ? (
              <tr><td colSpan={4} style={{ padding: "24px 16px", color: "var(--ink-faint)", fontSize: 13, textAlign: "center" }}>No commissions yet.</td></tr>
            ) : (
              rows.map((r) => (
                <tr key={r.id}>
