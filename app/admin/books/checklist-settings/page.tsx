...
/**
 * Lets an Admin or Chief Editor define exactly what the review
 * checklist asks for on every book (Metadata: Title/Author/SN-ISBN,
 * Appropriate: children's book/age selection/copyright, etc.) —
...
export default async function ChecklistSettingsPage() {
  ...
  return (
    <AdminShell role={session.user.role} activeKey="books-checklist" displayName={session.user.name ?? ""}>
